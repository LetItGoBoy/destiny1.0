...
const SHENSHA = {
  ...
  文昌贵人: { by: 'stem', refs: ['day'], map: { 甲: ['巳'], 乙: ['午'], 丙: ['申'], 戊: ['申'], 丁: ['酉'], 己: ['酉'], 庚: ['亥'], 辛: ['子'], 壬: ['寅'], 癸: ['卯'] } },
  福星贵人: { by: 'stem', refs: ['day'], map: { 甲: ['寅'], 丙: ['寅'], 乙: ['丑'], 癸: ['丑'], 丁: ['卯'], 戊: ['申'], 己: ['未'], 庚: ['午'], 辛: ['巳'], 壬: ['辰'] } },
  天厨贵人: { by: 'stem', refs: ['day'], map: { 甲: ['巳'], 乙: ['午'], 丙: ['巳'], 丁: ['午'], 戊: ['申'], 己: ['酉'], 庚: ['亥'], 辛: ['子'], 壬: ['寅'], 癸: ['卯'] } },
  国印贵人: { by: 'stem', refs: ['day'], map: { 甲: ['戌'], 乙: ['亥'], 丙: ['丑'], 丁: ['寅'], 戊: ['丑'], 己: ['寅'], 庚: ['辰'], 辛: ['巳'], 壬: ['未'], 癸: ['申'] } },
